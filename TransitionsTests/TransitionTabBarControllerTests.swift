//
//  TransitionTabBarControllerTests.swift
//  Transitions
//
...
class TransitionTabBarControllerTests: XCTestCase {
    ...
    func testNotInteractive() {
        let viewController = TransitionTabBarControllerMock()
    ...
    func testNoConfigurationRelease() {
        weak var vc: TransitionTabBarControllerMock?
...
class TransitionTabBarControllerMock: TransitionTabBarController {
