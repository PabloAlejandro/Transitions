#
#  Be sure to run `pod spec lint Transitions.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/PabloAlejandro/Transitions.git", :tag => "#{s.version}" }
  ...
  #, "TransitionsTests/*Tests.{swift}"

#s.test.resource_bundle = ['TransitionsTests/**/*']
